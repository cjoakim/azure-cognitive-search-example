...
# Bash script with AZ CLI to automate the creation/deletion of an Azure Cognitive Services account.
# Chris Joakim, 2020/09/26
#
# See https://docs.microsoft.com/en-us/cli/azure/cognitiveservices/account?view=azure-cli-latest
